    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="glass-strong rounded-2xl p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl glass-input text-sm text-white placeholder:text-[#6b6b7b]"
                required
              />
            </div>
          </div>
          ...
          <div>
            <label className="block text-xs text-[#a0a0b0] mb-1.5">Password</label>
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 pr-10 py-3 rounded-xl glass-input text-sm text-white placeholder:text-[#6b6b7b]"
                required
              />
              <button
                type="button"
